...
<body >
<center><br>
<h1><medium>&nbsp;&nbsp;&nbsp;&nbsp;L O G I N&nbsp;&nbsp;</medium></h1>
<br><br><br>
<form method ="POST" name="frm" onsubmit="return Tvalidate()">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="1donor.php"> NEW REGISTRATION</a></td></tr>
<tr><td colspan="2" align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
//else
//echo"successful connection<br>";
$qr=mysqli_query($conn,"select * from login where uid='$uid' and pwd='$pwd' and role='donor'") or die("Error:".mysqli_error($conn)); //and Role='Technician'
...
header("refresh:3;url=dlogin.php");
}
mysqli_close($conn);
}
?>
